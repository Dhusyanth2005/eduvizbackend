...
const uploadProfilePicture = async (req, res) => {
  try {
    ...
    const result = await new Promise((resolve, reject) => {
      ...
      stream.end(req.file.buffer); // Use buffer from memory storage
    });
    ...
    res.json({ 
      ...
      profilePicture: result.secure_url // Return Cloudinary URL
    });
  } catch (error) {
...
const updateUserProfile = async (req, res) => {
  try {
    ...
    if (profilePicture !== undefined) user.profilePicture = profilePicture; // Cloudinary URL
